namespace SimpleWorkfloorManagementSuite.Dialogs {
	partial class TimeTableTemplateEntryDetailDialog {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			this.browseForTimeTablePurposeButton = new SwmSuite.Presentation.Common.ButtonControl();
			this.timeTablePurposeTextBox = new SwmSuite.Presentation.Common.NiceTextBox.NiceTextBoxControl();
			...
			this.dialogHeaderControl.Size = new System.Drawing.Size( 340 , 50 );
			this.dialogHeaderControl.SubText = "#Details#";
			this.dialogHeaderControl.TabIndex = 15;
			...
			this.groupControl1.Caption = "Tijd";
			this.groupControl1.Controls.Add( this.label2 );
			this.groupControl1.Controls.Add( this.stopDateTimePicker );
			this.groupControl1.Controls.Add( this.label1 );
			this.groupControl1.Controls.Add( this.startDateTimePicker );
			...
			this.groupControl1.Size = new System.Drawing.Size( 318 , 64 );
			...
			// stopDateTimePicker
			// 
			this.stopDateTimePicker.CustomFormat = "HH:mm";
			this.stopDateTimePicker.Font = new System.Drawing.Font( "Verdana" , 10F );
			this.stopDateTimePicker.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this.stopDateTimePicker.Location = new System.Drawing.Point( 218 , 22 );
			this.stopDateTimePicker.Name = "stopDateTimePicker";
			this.stopDateTimePicker.ShowUpDown = true;
			this.stopDateTimePicker.Size = new System.Drawing.Size( 86 , 24 );
			this.stopDateTimePicker.TabIndex = 3;
			...
			this.startDateTimePicker.Font = new System.Drawing.Font( "Verdana" , 10F );
			this.startDateTimePicker.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this.startDateTimePicker.Location = new System.Drawing.Point( 53 , 22 );
			this.startDateTimePicker.Name = "startDateTimePicker";
			this.startDateTimePicker.ShowUpDown = true;
			this.startDateTimePicker.Size = new System.Drawing.Size( 86 , 24 );
			...
			this.groupControl2.Anchor = ( (System.Windows.Forms.AnchorStyles)( ( ( System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left )
							| System.Windows.Forms.AnchorStyles.Right ) ) );
			this.groupControl2.Caption = "Categorie";
			this.groupControl2.Controls.Add( this.browseForTimeTablePurposeButton );
			this.groupControl2.Controls.Add( this.timeTablePurposeTextBox );
			...
			this.groupControl2.Size = new System.Drawing.Size( 318 , 63 );
			this.groupControl2.TabIndex = 17;
			// 
			// browseForTimeTablePurposeButton
			// 
			this.browseForTimeTablePurposeButton.Anchor = ( (System.Windows.Forms.AnchorStyles)( ( System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right ) ) );
			this.browseForTimeTablePurposeButton.Caption = "...";
			this.browseForTimeTablePurposeButton.Location = new System.Drawing.Point( 250 , 26 );
			this.browseForTimeTablePurposeButton.Name = "browseForTimeTablePurposeButton";
			this.browseForTimeTablePurposeButton.Picture = null;
			this.browseForTimeTablePurposeButton.Renderer = buttonRenderer1;
			...
			this.browseForTimeTablePurposeButton.SchemeDisabled = buttonScheme1;
			...
			this.browseForTimeTablePurposeButton.SchemeHovered = buttonScheme2;
			...
			this.browseForTimeTablePurposeButton.SchemeNormal = buttonScheme3;
			...
			this.browseForTimeTablePurposeButton.SchemePushed = buttonScheme4;
			this.browseForTimeTablePurposeButton.Size = new System.Drawing.Size( 65 , 22 );
			this.browseForTimeTablePurposeButton.State = SwmSuite.Presentation.Common.ButtonState.Normal;
			this.browseForTimeTablePurposeButton.TabIndex = 32;
			this.browseForTimeTablePurposeButton.Text = "...";
			this.browseForTimeTablePurposeButton.UseVisualStyleBackColor = true;
			this.browseForTimeTablePurposeButton.Click += new System.EventHandler( this.browseForTimeTablePurposeButton_Click );
			// 
			// timeTablePurposeTextBox
			// 
			this.timeTablePurposeTextBox.Anchor = ( (System.Windows.Forms.AnchorStyles)( ( ( System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left )
							| System.Windows.Forms.AnchorStyles.Right ) ) );
			this.timeTablePurposeTextBox.BackColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 232 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 239 ) ) ) ) );
			this.timeTablePurposeTextBox.BorderColorFocused = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 160 ) ) ) ) , ( (int)( ( (byte)( 17 ) ) ) ) );
			this.timeTablePurposeTextBox.BorderColorHovered = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 153 ) ) ) ) , ( (int)( ( (byte)( 207 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) );
			this.timeTablePurposeTextBox.BorderColorNormal = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 125 ) ) ) ) , ( (int)( ( (byte)( 170 ) ) ) ) , ( (int)( ( (byte)( 210 ) ) ) ) );
			// 
			// 
			// 
			this.timeTablePurposeTextBox.Client.BackColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 232 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 239 ) ) ) ) );
			this.timeTablePurposeTextBox.Client.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.timeTablePurposeTextBox.Client.Font = new System.Drawing.Font( "Verdana" , 9.75F , System.Drawing.FontStyle.Regular , System.Drawing.GraphicsUnit.Point , ( (byte)( 0 ) ) );
			this.timeTablePurposeTextBox.Client.Location = new System.Drawing.Point( 4 , 2 );
			this.timeTablePurposeTextBox.Client.Name = "textbox";
			this.timeTablePurposeTextBox.Client.ReadOnly = true;
			this.timeTablePurposeTextBox.Client.Size = new System.Drawing.Size( 226 , 16 );
			this.timeTablePurposeTextBox.Client.TabIndex = 0;
			this.timeTablePurposeTextBox.ContentsDisableColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 240 ) ) ) ) , ( (int)( ( (byte)( 240 ) ) ) ) , ( (int)( ( (byte)( 240 ) ) ) ) );
			this.timeTablePurposeTextBox.ContentsErrorColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 232 ) ) ) ) , ( (int)( ( (byte)( 232 ) ) ) ) );
			this.timeTablePurposeTextBox.ContentsOkColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 232 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 239 ) ) ) ) );
			this.timeTablePurposeTextBox.Location = new System.Drawing.Point( 9 , 26 );
			this.timeTablePurposeTextBox.Name = "timeTablePurposeTextBox";
			this.timeTablePurposeTextBox.Size = new System.Drawing.Size( 235 , 22 );
			this.timeTablePurposeTextBox.TabIndex = 33;
			this.timeTablePurposeTextBox.TabStop = false;
			this.timeTablePurposeTextBox.TextChanged += new System.EventHandler<System.EventArgs>( this.timeTablePurposeTextBox_TextChanged );
			// 
			// cancelButton
			// 
			...
			this.cancelButton.Location = new System.Drawing.Point( 87 , 204 );
			this.cancelButton.Name = "cancelButton";
			this.cancelButton.Picture = null;
			this.cancelButton.Renderer = buttonRenderer2;
			...
			this.cancelButton.SchemeDisabled = buttonScheme5;
			...
			this.cancelButton.SchemeHovered = buttonScheme6;
			...
			this.cancelButton.SchemeNormal = buttonScheme7;
			...
			this.cancelButton.SchemePushed = buttonScheme8;
			...
			this.okButton.Renderer = buttonRenderer3;
			...
			this.okButton.SchemeDisabled = buttonScheme9;
			...
			this.okButton.SchemeHovered = buttonScheme10;
			...
			this.okButton.SchemeNormal = buttonScheme11;
			...
			this.okButton.SchemePushed = buttonScheme12;
			...
			// 
			// TimeTableTemplateEntryDetailDialog
			// 
			...
			this.Name = "TimeTableTemplateEntryDetailDialog";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Simple Workfloor Management Suite";
			this.Load += new System.EventHandler( this.TimeTableTemplateEntryDetailDialog_Load );
		...
		private SwmSuite.Presentation.Common.ButtonControl browseForTimeTablePurposeButton;
		private SwmSuite.Presentation.Common.NiceTextBox.NiceTextBoxControl timeTablePurposeTextBox;
