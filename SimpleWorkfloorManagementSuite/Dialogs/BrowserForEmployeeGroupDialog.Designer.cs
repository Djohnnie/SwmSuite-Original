namespace SimpleWorkfloorManagementSuite.Dialogs {
	...
	partial class BrowserForEmployeeGroupDialog {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			SwmSuite.Presentation.Common.ButtonRenderer buttonRenderer4 = new SwmSuite.Presentation.Common.ButtonRenderer();
			SwmSuite.Presentation.Common.ButtonScheme buttonScheme13 = new SwmSuite.Presentation.Common.ButtonScheme();
			System.Drawing.StringFormat stringFormat13 = new System.Drawing.StringFormat();
			SwmSuite.Presentation.Common.ButtonScheme buttonScheme14 = new SwmSuite.Presentation.Common.ButtonScheme();
			System.Drawing.StringFormat stringFormat14 = new System.Drawing.StringFormat();
			SwmSuite.Presentation.Common.ButtonScheme buttonScheme15 = new SwmSuite.Presentation.Common.ButtonScheme();
			System.Drawing.StringFormat stringFormat15 = new System.Drawing.StringFormat();
			SwmSuite.Presentation.Common.ButtonScheme buttonScheme16 = new SwmSuite.Presentation.Common.ButtonScheme();
			...
			this.employeesTreeView = new SwmSuite.Presentation.Common.BrowserTreeView.BrowserTreeViewControl();
			...
			this.employeesBrowserView = new SwmSuite.Presentation.Common.BrowserView.BrowserViewControl();
			...
			this.splitContainer.Size = new System.Drawing.Size( 635 , 273 );
			this.splitContainer.SplitterDistance = 270;
			this.splitContainer.TabIndex = 22;
			// 
			// groupControl1
			// 
			this.groupControl1.Caption = "Personeelsleden";
			this.groupControl1.Controls.Add( this.employeesTreeView );
			...
			this.groupControl1.Size = new System.Drawing.Size( 270 , 273 );
			this.groupControl1.TabIndex = 0;
			// 
			// employeesTreeView
			// 
			this.employeesTreeView.Anchor = ( (System.Windows.Forms.AnchorStyles)( ( ( ( System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom )
							| System.Windows.Forms.AnchorStyles.Left )
							| System.Windows.Forms.AnchorStyles.Right ) ) );
			this.employeesTreeView.Font = new System.Drawing.Font( "Verdana" , 10F );
			this.employeesTreeView.FullRowSelect = true;
			this.employeesTreeView.HideSelection = false;
			this.employeesTreeView.Location = new System.Drawing.Point( 3 , 21 );
			this.employeesTreeView.Name = "employeesTreeView";
			this.employeesTreeView.Size = new System.Drawing.Size( 264 , 249 );
			this.employeesTreeView.TabIndex = 0;
			this.employeesTreeView.NodeMouseDoubleClick += new System.Windows.Forms.TreeNodeMouseClickEventHandler( this.employeesTreeView_NodeMouseDoubleClick );
			// 
			// groupControl2
			// 
			this.groupControl2.Caption = "Selectie";
			this.groupControl2.Controls.Add( this.removeButton );
			this.groupControl2.Controls.Add( this.addButton );
			this.groupControl2.Controls.Add( this.employeesBrowserView );
			this.groupControl2.Dock = System.Windows.Forms.DockStyle.Fill;
			this.groupControl2.Location = new System.Drawing.Point( 0 , 0 );
			this.groupControl2.Name = "groupControl2";
			this.groupControl2.Renderer = groupRenderer2;
			...
			this.groupControl2.Scheme = groupScheme2;
			this.groupControl2.Size = new System.Drawing.Size( 361 , 273 );
			this.groupControl2.TabIndex = 1;
			// 
			// removeButton
			// 
			this.removeButton.Caption = null;
			this.removeButton.Location = new System.Drawing.Point( 0 , 75 );
			this.removeButton.Name = "removeButton";
			this.removeButton.Picture = global::SimpleWorkfloorManagementSuite.Properties.Resources.remove;
			...
			this.removeButton.Text = "buttonControl3";
			this.removeButton.UseVisualStyleBackColor = true;
			this.removeButton.Click += new System.EventHandler( this.removeButton_Click );
			// 
			// addButton
			// 
			this.addButton.Caption = null;
			this.addButton.Location = new System.Drawing.Point( 0 , 48 );
			this.addButton.Name = "addButton";
			this.addButton.Picture = global::SimpleWorkfloorManagementSuite.Properties.Resources.add;
			...
			this.addButton.Text = "buttonControl2";
			this.addButton.UseVisualStyleBackColor = true;
			this.addButton.Click += new System.EventHandler( this.addButton_Click );
			// 
			// employeesBrowserView
			// 
			this.employeesBrowserView.Anchor = ( (System.Windows.Forms.AnchorStyles)( ( ( ( System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom )
							| System.Windows.Forms.AnchorStyles.Left )
							| System.Windows.Forms.AnchorStyles.Right ) ) );
			this.employeesBrowserView.Columns.AddRange( new System.Windows.Forms.ColumnHeader[] {
            this.columnHeader1} );
			this.employeesBrowserView.Location = new System.Drawing.Point( 32 , 21 );
			this.employeesBrowserView.Name = "employeesBrowserView";
			this.employeesBrowserView.OwnerDraw = true;
			this.employeesBrowserView.Renderer = browserViewRenderer1;
			...
			this.employeesBrowserView.Scheme = browserViewScheme1;
			this.employeesBrowserView.Size = new System.Drawing.Size( 326 , 249 );
			this.employeesBrowserView.TabIndex = 0;
			this.employeesBrowserView.UseCompatibleStateImageBehavior = false;
			this.employeesBrowserView.View = System.Windows.Forms.View.Details;
			// 
			// columnHeader1
			// 
			...
			this.cancelButton.Location = new System.Drawing.Point( 406 , 335 );
			this.cancelButton.Name = "cancelButton";
			this.cancelButton.Picture = null;
			this.cancelButton.Renderer = buttonRenderer3;
			...
			buttonScheme9.BorderColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) );
			buttonScheme9.CaptionColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) );
			...
			this.cancelButton.SchemeDisabled = buttonScheme9;
			...
			this.cancelButton.SchemeHovered = buttonScheme10;
			...
			this.cancelButton.SchemeNormal = buttonScheme11;
			...
			this.cancelButton.SchemePushed = buttonScheme12;
			...
			this.okButton.Location = new System.Drawing.Point( 532 , 335 );
			this.okButton.Name = "okButton";
			this.okButton.Picture = null;
			this.okButton.Renderer = buttonRenderer4;
			buttonScheme13.BackgroundColor1 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) );
			buttonScheme13.BackgroundColor2 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 237 ) ) ) ) , ( (int)( ( (byte)( 237 ) ) ) ) , ( (int)( ( (byte)( 237 ) ) ) ) );
			buttonScheme13.BackgroundGradientMode = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
			buttonScheme13.BorderColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) );
			buttonScheme13.CaptionColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) , ( (int)( ( (byte)( 200 ) ) ) ) );
			buttonScheme13.CaptionFont = new System.Drawing.Font( "Verdana" , 10F );
			...
			buttonScheme13.CaptionFormat = stringFormat13;
			buttonScheme13.CaptionRendering = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
			this.okButton.SchemeDisabled = buttonScheme13;
			buttonScheme14.BackgroundColor1 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 246 ) ) ) ) , ( (int)( ( (byte)( 251 ) ) ) ) , ( (int)( ( (byte)( 253 ) ) ) ) );
			buttonScheme14.BackgroundColor2 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 213 ) ) ) ) , ( (int)( ( (byte)( 239 ) ) ) ) , ( (int)( ( (byte)( 252 ) ) ) ) );
			buttonScheme14.BackgroundGradientMode = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
			buttonScheme14.BorderColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 64 ) ) ) ) , ( (int)( ( (byte)( 64 ) ) ) ) , ( (int)( ( (byte)( 64 ) ) ) ) );
			buttonScheme14.CaptionColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 0 ) ) ) ) , ( (int)( ( (byte)( 0 ) ) ) ) , ( (int)( ( (byte)( 0 ) ) ) ) );
			buttonScheme14.CaptionFont = new System.Drawing.Font( "Verdana" , 10F );
			...
			buttonScheme14.CaptionFormat = stringFormat14;
			buttonScheme14.CaptionRendering = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
			this.okButton.SchemeHovered = buttonScheme14;
			buttonScheme15.BackgroundColor1 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) , ( (int)( ( (byte)( 255 ) ) ) ) );
			buttonScheme15.BackgroundColor2 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 237 ) ) ) ) , ( (int)( ( (byte)( 237 ) ) ) ) , ( (int)( ( (byte)( 237 ) ) ) ) );
			buttonScheme15.BackgroundGradientMode = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
			buttonScheme15.BorderColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 64 ) ) ) ) , ( (int)( ( (byte)( 64 ) ) ) ) , ( (int)( ( (byte)( 64 ) ) ) ) );
			buttonScheme15.CaptionColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 0 ) ) ) ) , ( (int)( ( (byte)( 0 ) ) ) ) , ( (int)( ( (byte)( 0 ) ) ) ) );
			buttonScheme15.CaptionFont = new System.Drawing.Font( "Verdana" , 10F );
			...
			buttonScheme15.CaptionFormat = stringFormat15;
			buttonScheme15.CaptionRendering = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
			this.okButton.SchemeNormal = buttonScheme15;
			buttonScheme16.BackgroundColor1 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 214 ) ) ) ) , ( (int)( ( (byte)( 214 ) ) ) ) , ( (int)( ( (byte)( 214 ) ) ) ) );
			buttonScheme16.BackgroundColor2 = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 231 ) ) ) ) , ( (int)( ( (byte)( 231 ) ) ) ) , ( (int)( ( (byte)( 231 ) ) ) ) );
			buttonScheme16.BackgroundGradientMode = System.Drawing.Drawing2D.LinearGradientMode.Vertical;
			buttonScheme16.BorderColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 64 ) ) ) ) , ( (int)( ( (byte)( 64 ) ) ) ) , ( (int)( ( (byte)( 64 ) ) ) ) );
			buttonScheme16.CaptionColor = System.Drawing.Color.FromArgb( ( (int)( ( (byte)( 0 ) ) ) ) , ( (int)( ( (byte)( 0 ) ) ) ) , ( (int)( ( (byte)( 0 ) ) ) ) );
			buttonScheme16.CaptionFont = new System.Drawing.Font( "Verdana" , 10F );
			...
			buttonScheme16.CaptionFormat = stringFormat16;
			buttonScheme16.CaptionRendering = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
			this.okButton.SchemePushed = buttonScheme16;
			...
			this.dialogHeaderControl.MainText = "Personeelslid selectie";
			...
			this.dialogHeaderControl.Size = new System.Drawing.Size( 659 , 50 );
			this.dialogHeaderControl.SubText = "#Details#";
			this.dialogHeaderControl.TabIndex = 19;
			this.dialogHeaderControl.TabStop = false;
			// 
			// BrowserForEmployeeGroupDialog
			// 
			...
			this.Name = "BrowserForEmployeeGroupDialog";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Simple Workfloor Management Suite";
			this.Load += new System.EventHandler( this.BrowserForEmployeeDialog_Load );
		...
		private SwmSuite.Presentation.Common.BrowserTreeView.BrowserTreeViewControl employeesTreeView;
		private SwmSuite.Presentation.Common.BrowserView.BrowserViewControl employeesBrowserView;
