...
namespace SwmSuite.Presentation.Common.ApplicationIdle {
	...
	public class ApplicationIdle : Component , IMessageFilter {
		...
		#region -_ Event Raising and Asynchronous Callback Methods _-
		...
		#region -_ IMessageFilter Members _-
