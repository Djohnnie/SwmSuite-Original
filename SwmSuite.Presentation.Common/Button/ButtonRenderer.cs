...
namespace SwmSuite.Presentation.Common {
	...
	public class ButtonRenderer : IDisposable {
		...
		public void RenderBackground( Graphics g , Rectangle drawRectangle , ButtonScheme scheme ) {
		...
		public void RenderBorder( Graphics g , Rectangle drawRectangle , ButtonScheme scheme ) {
		...
		public void RenderCaption( Graphics g , Rectangle drawRectangle , String caption , ButtonScheme scheme ) {
			g.TextRenderingHint = TextRenderingHint.ClearTypeGridFit;
			g.DrawString( caption , scheme.CaptionFont , GetCaptionBrush( scheme ) , drawRectangle , GetCaptionFormat() );
		...
		private SolidBrush GetCaptionBrush( ButtonScheme scheme ) {
			if( _captionBrush == null ) {
